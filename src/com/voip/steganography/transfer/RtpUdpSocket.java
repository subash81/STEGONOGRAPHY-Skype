 ...
 */
public class RtpUdpSocket {

        /** DatagramSocket */
        DatagramSocket socket;

        /** Creates a new UdpSocket */
        public RtpUdpSocket() throws java.net.SocketException {
                socket = new DatagramSocket();
        }

        /** Creates a new UdpSocket */
        public RtpUdpSocket(int port) throws java.net.SocketException {
                socket = new DatagramSocket(port);
        }

        /** Creates a new UdpSocket */
        public RtpUdpSocket(DatagramSocket sock) {
                socket = sock;
        }

        /** Creates a new UdpSocket */
        public RtpUdpSocket(int port, IpAddress ipaddr)
        ...
        public void receive(RtpUdpPacket pkt) throws java.io.IOException {
        ...
        public void send(RtpUdpPacket pkt) throws java.io.IOException {
