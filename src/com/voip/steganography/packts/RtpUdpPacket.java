...
public class RtpUdpPacket {
     ...
     RtpUdpPacket(DatagramPacket packet) {
             this.packet = packet;
     }
     ...
     /** Creates a new UdpPacket */
     public RtpUdpPacket(byte[] buf, int length) {
             packet = new DatagramPacket(buf, length);
     }

     /** Creates a new UdpPacket */
     public RtpUdpPacket(byte[] buf, int length, IpAddress ipaddr, int port) {
             packet = new DatagramPacket(buf, length, ipaddr.getInetAddress(), port);
     }

     /** Creates a new UdpPacket */
     public RtpUdpPacket(byte[] buf, int offset, int length) {
             packet = new DatagramPacket(buf, offset, length);
     }

     /** Creates a new UdpPacket */
     public RtpUdpPacket(byte[] buf, int offset, int length, IpAddress ipaddr,
                     int port) {
