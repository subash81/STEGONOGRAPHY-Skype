...
public final class ChatMessage extends SkypeObject {
	...
	public enum Type {
		 ...
		 * UNKNOWN - other.
		 */
        SETTOPIC, SAID, ADDEDMEMBERS, SAWMEMBERS, CREATEDCHATWITH, LEFT, POSTEDCONTACTS, GAP_IN_CHAT, SETROLE, KICKED, KICKBANNED, SETOPTIONS, SETPICTURE, SETGUIDELINES, JOINEDASAPPLICANT, EMOTED, UNKNOWN;
    }
